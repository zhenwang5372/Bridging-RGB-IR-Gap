...
# DroneVehicle-specific Transforms for RGB-IR Dual-Modal Detection
#
# ============================================================================
# 模块说明 (Module Description):
# ============================================================================
# 本文件实现 DroneVehicle 数据集专用的图像加载 Transform。
#
# 与其他数据集 LoadIR 的区别:
...
class LoadIRImageFromFileDroneVehicle(BaseTransform):
    """
    Load IR image for DroneVehicle dataset based on RGB image path.
    
    DroneVehicle uses directory-based separation for RGB and IR images:
        - RGB: trainimg/00001.jpg, valimg/00001.jpg, testimg/00001.jpg
        - IR:  trainimgr/00001.jpg, valimgr/00001.jpg, testimgr/00001.jpg
    ...
    def _get_ir_path(self, rgb_path: str) -> str:
        ...
        Replace directory name: trainimg -> trainimgr, valimg -> valimgr, etc.
        ...
        """
        # Replace directory: trainimg -> trainimgr
