...
# IR Backbone: LiteDCTGhostIRBackboneV2 (DCT + Enhanced Ghost Module + FPN)
#
# ============================================================================
...
# IR RGB M_err M_cons Module既纠错又共识增强
...
# ======================== Data Settings ========================
data_root = '/home/enhao02/wangzhen/data/data/flir/root/autodl-tmp/data/FLIR_V1_aligned/align/'
...
train_dataset = dict(
    ...
    class_text_path='data/data/flir/texts/flir_class_texts.json',
