...
# 训练参数
CONFIG="configs/custom_flir/ir_correction_rgb_fusion/yolow_v2_rgb_ir_flir_with_text_guided_fusion_v5.py"
# WORK_DIR="work_dirs/text_guided_ir_correction/20260114/seed3407"
WORK_DIR="work_dirs/ir_correction_rgb_fusion/V5/mask_supervision"
BATCH_SIZE=16
LEARNING_RATE=0.0015
MAX_EPOCHS=300

echo "========================================="
echo "Text-Guided RGB-IR Fusion Training (Scheme 2)"
echo "========================================="
echo "Config: ${CONFIG}"
