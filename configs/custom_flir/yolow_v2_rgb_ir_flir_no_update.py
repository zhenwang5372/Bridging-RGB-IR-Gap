...
# YOLO-World v2 RGB-IR No-Neck Baseline Configuration for FLIR Dataset
# 
# 架构说明:
# - Backbone: RGB-IR Fusion (MultiLevelRGBIRFusion)
# - Neck: SimpleChannelAlign (只做通道对齐，不做任何融合/更新)
# - Head: 标准YOLOWorldHead
# 
# 目的: 验证Backbone-level Fusion是否已经足够，不需要复杂的Neck更新
...
model = dict(
    ...
    neck=dict(
        ...
        out_channels=[128, 256, 512],  # ✅ Head实际期望 (256*0.5=128, 512*0.5=256, 1024*0.5=512)
    ),
    bbox_head=dict(
        type='YOLOWorldHead',
        head_module=dict(
