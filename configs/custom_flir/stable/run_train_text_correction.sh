...
# 训练参数
CONFIG="configs/custom_flir/stable/yolow_v2_rgb_ir_flir_stable_with_text_update_classmask.py"
# WORK_DIR="work_dirs/text_guided_ir_correction/20260114/seed3407"
WORK_DIR="work_dirs/RGBenhancement/text_correction_stable/with_text_update/classmask/use_confidence_gate_False_crossbatch_True/"
BATCH_SIZE=16   
