...
# YOLO-World v2 RGB-IR with Text-Guided IR Correction V5 for FLIR Dataset
#
# V5 核心改动：
...
cosine_scale = 10.0      # ⭐ V5 新增：余弦相似度缩放因子
log_alpha = True
log_interval = 50
...
model = dict(
    ...
    backbone=dict(
        _delete_=True,
        type='DualStreamMultiModalYOLOBackboneWithCorrectionV5',  # ⭐ 使用V5版本
        # RGB backbone
        image_model=dict(
        ...
        # ⭐ Text-guided IR纠错模块 V5 (Cosine Similarity + Alpha -0.3)
        ir_correction=dict(
            type='TextGuidedIRCorrectionV5',
