...
# 修改ir_correction模块为IRCorrectionV4Plus,直接用Fextracted进行纠错
...
model = dict(
    ...
    backbone=dict(
        _delete_=True,
        type='DualStreamMultiModalYOLOBackboneWithCorrectionV4Plus',  # ⭐ 使用V4版本
        # RGB backbone
        image_model=dict(
        ...
        ir_correction=dict(
            type='TextGuidedIRCorrectionV4Plus',
