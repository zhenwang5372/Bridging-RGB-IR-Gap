...
# ============================
# DroneVehicle RGB-IR Training Script (独立测试集)
# ============================
...
# 训练参数
CONFIG="configs/custom_dronevehicle/dronevehicle_remove_whiteborders_640_val.py"
WORK_DIR="work_dirs/dronevehicle/remove_clip_less_5px/Alpha_-0.5/Beta_0.5"
BATCH_SIZE=16   
LEARNING_RATE=0.0015
MAX_EPOCHS=300

echo "========================================="
echo "DroneVehicle RGB-IR Training (Independent Test)"
echo "========================================="
echo "Config: ${CONFIG}"
