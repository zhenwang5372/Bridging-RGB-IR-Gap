...
# ============================
# DroneVehicle RGB-IR Training Script (测试集复用验证集)
# ============================
...
# 训练参数
CONFIG="configs/custom_dronevehicle/dronevehicle_withwhiteboders_640_val.py"
WORK_DIR="work_dirs/dronevehicle/val_as_test/Alpha_-0.5/Beta_0.5"
BATCH_SIZE=32   
LEARNING_RATE=0.003
MAX_EPOCHS=300

echo "========================================="
echo "DroneVehicle RGB-IR Training (Val as Test)"
echo "========================================="
echo "Config: ${CONFIG}"
