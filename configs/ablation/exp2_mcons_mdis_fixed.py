# ============================================================================
# 消融实验 exp2_mcons_mdis_fixed: M_cons + M_dis (Fixed Coefficients)
#
# 同时使用 M_cons 和 M_err 双分支，但 alpha/beta 固定不可学习
# 公式: ir_corrected = x_ir * (1 + beta * Cons_map) * (1 - alpha * Error_map)
#   其中 alpha=-0.5 (固定), beta=0.5 (固定)
# ============================================================================
