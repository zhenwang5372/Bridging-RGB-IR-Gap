...
ir_out_channels = [64, 128, 256]  # LiteFFTIRBackbone (base_channels=32)
...
model = dict(
    ...
    backbone=dict(
        ...
        # IR backbone: LiteFFTIRBackbone (base_channels=32)
        ir_model=dict(
